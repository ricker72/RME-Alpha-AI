# Manual do Usuário - RME Agente AI Alpha

RME Agente AI Alpha é uma versão alfa do workspace/editor do projeto RME Agente AI. Esta versão destina-se a testes iniciais de abertura, visualização, edição, geração assistida por IA e exportação de mapas OpenTibia compatíveis com Canary/RME.

O aplicativo ainda está em desenvolvimento. Se encontrar problemas, envie um relatório usando o modelo descrito no final deste manual.

## 1. Arquivos que Devem ser Extraídos
...
## 4. Como Solicitar um Mapa para a IA
